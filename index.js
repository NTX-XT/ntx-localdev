...
const options = program
    .description('A local server for Nintex Form Plugins development')
    .requiredOption('-f, --folder <path>', 'Absolute or relative path to the folder containing the js plugin files')
